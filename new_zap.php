...
$API_KEY='693943288:AAHEYMcNRLbUxwxP4EgX3qzTso2LT0CJPPE';
...
'inline_keyboard'=>[
        ...
        [
        ['text'=>'👑Sudanese|Gamers👑', 'url'=>"https://telegram.me/AK_47A"]
        ],
]
])
]);
...
[
['text'=>"هل لديك سؤال ❔ ","url"=>"https://telegram.me/AK_47A"]
]
]
])
]);
...
if($message->reply_to_message && $text == "ايدي"){
bot('sendMessage',[
'chat_id'=>$chat_id,
...
[
['text'=>"اصدر البوت بتاريخ 📅 2019/3/3 ☘", "callback_data"=>"omar"]
]
]
])
]);
